...
## About Me
<tr>
    <td> <img class="profile-picture" src="assets/me_canyon.jpg" style="width: 25%; height: auto;"></td>
    <td><div class="profile-doc">
        <strong>Austin Paul</strong><br>
        B.Tech (CSE, Data Science), Second-year — SRM IST Kattankulathur, Tamil Nadu, India<br>
        <br>
        Interested in full-stack & front-end development, embedded systems (Arduino), MATLAB/Simulink, and data science.<br>
        Passionate about building practical solutions that bridge software and hardware.
        <br><br>
        <a href="mailto:your-email@example.com">
            <i class="fa fa-envelope" aria-hidden="true"></i> your-email@example.com</a> <br>
        <a href="https://github.com/your-github-username">
            <i class="fa fa-github" aria-hidden="true"></i> GitHub</a> <br>
        <a href="cv.pdf">
            <i class="fa fa-file-pdf-o" aria-hidden="true"></i> CV</a>
        <br><br>
        <strong>Skills:</strong> Python, Java, C++, pandas, NumPy, scikit-learn, HTML/CSS/JS, Arduino, Simulink, Git.
        <br><br>
        <strong>Selected Projects:</strong>
        <ul>
            <li>Disaster Management Android App — Bluetooth mesh offline alerts (inspired by BitChat).</li>
            <li>Wine Quality Analysis — Kaggle dataset analysis and visualisations.</li>
            <li>Hybrid Energy Simulink Model — Solar + Micro-hydro + Battery for remote villages.</li>
        </ul>
    </div></td>
</tr>
